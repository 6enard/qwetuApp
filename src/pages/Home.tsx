...
const Home: React.FC = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-orange-700 to-orange-500 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-in-up">
              Everyday Supplies Delivered to Your Door
            </h1>
            <p className="text-xl mb-8 opacity-90 overflow-hidden whitespace-nowrap border-r-4 border-white w-[ch] max-w-full animate-typewriter">
              Get all your essentials delivered directly to your room in minutes.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 rounded-xl hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                From snacks to toiletries, we've got all your hostel needs
                covered.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Pay with Safaricom M-Pesa STK push for secure and convenient
                transactions.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                No need to leave your room - we'll bring everything right to
                your door.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
            Start ordering your essentials today and experience the convenience
            of room delivery.
          </p>
