...
const Home: React.FC = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-fuchsia-500 to-fuchsia-700 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link
              to="/products"
              className="btn bg-white text-blue-700 hover:bg-blue-50 px-8 py-3 rounded-lg font-medium text-lg shadow-lg transition-all hover:shadow-xl"
            >
              Shop Now
            </Link>
          </div>
